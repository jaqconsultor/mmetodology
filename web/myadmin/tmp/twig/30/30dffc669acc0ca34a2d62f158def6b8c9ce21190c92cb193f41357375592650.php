...
class __TwigTemplate_6b76566f2d6f415a4e347cf0ce3e3a2e024178a4f3583e49e678c2c8124ba3a3 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\mmetodology\\web\\myadmin\\templates\\preferences\\header.twig");
    }
}
